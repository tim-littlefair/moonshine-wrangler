...
def populate_tone_mobile_product_metadata(cxn, json_filename):
    _TONE_MOBILE_MODULE_TYPES = ( )
    ( _TONE_MOBILE_APP_ID, ) = [ k for k in APPS.keys() if APPS[k][0] == 'fender-tone-mobile' ]
